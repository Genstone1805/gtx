...
const Header = {
    ...
    getPageType() {
        ...
        if (path.includes('/profile/') || path.includes('/credentials/')) return 'user';
        return 'public';
    },
    ...
    getNavLinks() {
        ...
        if (pageType === 'admin') {
            return [
                ...
                { href: 'pending-level2.html', label: 'Level 2 Approvals', id: 'pending-level2' },
                { href: 'pending-level3.html', label: 'Level 3 Approvals', id: 'pending-level3' },
                { href: '../create-gift-store.html', label: 'Gift Cards', id: 'gift-cards' },
                { href: '../profile/dashboard.html', label: 'My Profile', id: 'my-profile' },
        ...
        const userLinks = [
            { href: '../profile/dashboard.html', label: 'Dashboard', id: 'dashboard' },
            { href: '../profile/transaction-pin.html', label: 'Transaction PIN', id: 'transaction-pin' },
            { href: '../profile/profile-picture.html', label: 'Profile Picture', id: 'profile-picture' },
            { href: '../credentials/level2.html', label: 'Upgrade Account', id: 'level2' },
        ];

        // Add admin link if user is admin
        if (this.isAdmin()) {
            userLinks.push({ href: '../admin/dashboard.html', label: 'Admin Panel', id: 'admin' });
        }

        userLinks.push({ href: '#', label: 'Logout', id: 'logout', onclick: 'logout()' });
